...
const CACHE_NAME = `finnova-cache-alumnos-v${CACHE_VERSION}`;
    ...
    caches.keys().then((cacheNames) => {
      return Promise.all(
        cacheNames.map((cache) => {
          if (cache !== CACHE_NAME && cache.startsWith('finnova-cache-alumnos-v')) {
