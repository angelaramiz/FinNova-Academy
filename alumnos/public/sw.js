...
const CACHE_NAME = `aurafi-cache-alumnos-v${CACHE_VERSION}`;
    ...
    caches.keys().then((cacheNames) => {
      return Promise.all(
        cacheNames.map((cache) => {
          if (cache !== CACHE_NAME && cache.startsWith('aurafi-cache-alumnos-v')) {
