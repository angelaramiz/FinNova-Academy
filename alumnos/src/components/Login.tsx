    ...
    <div id="student-login-view" className="min-h-screen bg-[#060b16] flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="flex justify-center items-center gap-2">
          <div className="bg-slate-900 border border-slate-880/80 p-2.5 rounded-2xl text-teal-400 shadow-lg">
        ...
        <p className="mt-1 text-center text-xs text-slate-400">
          Portal de Alumnos • Acceso Restringido
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10 px-4">
        <div className="bg-[#0a0f1d]/80 border border-slate-800/60 backdrop-blur-xl py-8 px-6 shadow-2xl rounded-3xl sm:px-10 space-y-6">
          <div className="text-center space-y-1">
            <h3 className="text-sm font-bold text-slate-200">Iniciar Sesión</h3>
            <p className="text-[11px] text-slate-500">
              Ingresa a tu cuenta autorizada por control escolar.
            </p>
          </div>
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={loading}
              className="w-full flex justify-center items-center gap-2 py-2.5 px-4 bg-teal-500 hover:bg-teal-400 text-slate-950 text-xs font-extrabold rounded-xl shadow-md shadow-teal-500/10 hover:shadow-teal-500/20 transition duration-150 cursor-pointer disabled:opacity-50"
            >
              {loading ? (
          ...
          <div className="pt-4 border-t border-slate-850/60 space-y-2.5">
            <div className="flex items-center gap-1.5 text-indigo-400">
              ...
              <span className="text-[10px] font-bold font-mono uppercase tracking-wider">
                Bypass de Desarrollo (Cuentas Piloto)
              </span>
            </div>
