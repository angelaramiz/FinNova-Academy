...
export default function Login({ onLoginSuccess, backendWarming = false }: LoginProps) {
  ...
  const handleLoginSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || 'Error al validar las credenciales del alumno.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div id="student-login-view" className="min-h-screen bg-[#060b16] flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="flex justify-center items-center gap-2">
          <div className="bg-slate-900 border border-slate-800/80 p-2.5 rounded-2xl text-teal-400 shadow-lg">
        ...
        <p className="mt-1 text-center text-xs text-slate-400">
          Portal de Alumnos • Acceso Autorizado
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10 px-4">
        <div className="bg-[#0a0f1d]/80 border border-slate-800/60 backdrop-blur-xl py-8 px-6 shadow-2xl rounded-3xl sm:px-10 space-y-6">
          ...
          {backendWarming && (
            <div className="bg-amber-500/5 border border-amber-500/20 text-amber-405 p-3 rounded-2xl text-[11px] flex items-start gap-2.5 animate-pulse">
            ...
            <>
                ...
                <button
                  ...
                  className={`flex-1 py-1.5 rounded-lg text-[10px] font-semibold font-mono uppercase tracking-wider transition cursor-pointer text-center ${
                    loginMode === 'credentials'
                      ? 'bg-teal-500/10 border border-teal-500/30 text-teal-400 shadow-inner'
              ...
              <div className="text-center space-y-1 pt-2">
                ...
                <p className="text-[10px] text-slate-500 leading-normal">
                  {loginMode === 'credentials' 
                    ? 'Ingresa tus credenciales autorizadas. Se enviará un OTP por correo.' 
                  ...
                  <div>
                    ...
                    <div className="relative rounded-xl shadow-sm">
                      ...
                      <input
                        ...
                        value={email}
                        onChange={(e) => setEmail(e.target.value)}
                        placeholder="ej. student_tester@gmail.com"
                        className="block w-full bg-slate-950/50 border border-slate-850 rounded-xl pl-9 pr-3 py-2 text-xs text-slate-200 placeholder-slate-600 outline-none focus:border-teal-500/50 focus:ring-1 focus:ring-teal-500/20 transition font-normal"
                      />
                    </div>
                  </div>
              ...
              <div className="pt-3 border-t border-slate-850/60 space-y-2">
                ...
                <div className="bg-slate-950/40 p-2.5 rounded-xl border border-slate-850/80">
                  <button
                    type="button"
                    onClick={() => handleSelectMock('student_tester@gmail.com')}
                    disabled={loading || backendWarming}
                  ...
                  >
                    <div>
                      ...
                      <span className="text-[9px] text-slate-500 font-mono block mt-0.5">
                        student_tester@gmail.com
                      </span>
                    </div>
                    <span className="bg-indigo-500/10 border border-indigo-500/20 text-indigo-305 text-[8px] px-1.5 py-0.5 rounded-md font-mono">
                      Alumno
                    </span>
                  </button>
                </div>
            ...
            <form className="space-y-4 animate-fade-in" onSubmit={handleForceChangePasswordSubmit}>
              ...
              <div>
                ...
                <input
                  ...
                  className="block w-full bg-slate-950/50 border border-slate-850 rounded-xl px-3 py-2 text-xs text-slate-200 placeholder-slate-650 outline-none focus:border-teal-500/50 focus:ring-1 focus:ring-teal-500/20 transition"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="block w-full bg-slate-950/50 border border-slate-850 rounded-xl px-3 py-2 text-xs text-slate-200 placeholder-slate-655 outline-none focus:border-teal-500/50 focus:ring-1 focus:ring-teal-500/20 transition"
                />
              </div>
            ...
            <form className="space-y-5 animate-fade-in" onSubmit={handleOtpSubmit}>
              ...
              <div>
                ...
                <input
                  ...
                  className="block w-full text-center bg-slate-950/50 border border-slate-850 rounded-xl px-3 py-2.5 text-base font-bold font-mono tracking-[0.5em] text-teal-400 outline-none focus:border-teal-500/50 focus:ring-1 focus:ring-teal-500/20 transition placeholder-slate-700"
                />
              </div>
