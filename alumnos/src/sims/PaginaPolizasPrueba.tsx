...
export default function PaginaPolizasPrueba() {
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc', color: '#1e293b' }}>
      <header style={{ background: '#fff', borderBottom: '1px solid #e2e8f0', padding: '10px 16px', display: 'flex', alignItems: 'center', gap: 10 }}>
        <span style={{ fontWeight: 800, color: '#1e40af' }}>🔗 contalink</span>
        <span style={{ fontSize: 12, color: '#64748b' }}>Simulador Educativo · Contabilidad / Pólizas (prueba libre)</span>
      </header>
